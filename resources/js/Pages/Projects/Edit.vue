        ...
        <div class="max-w-md mx-auto sm:px-6 lg:px-8 bg-white ">
            <form class="p-4" @submit.prevent="submit">
                <div>
                    ...
                    <select v-model="form.skill_id" id="skill_id" name="skill_id" class="mt-1 block w-full pl-3 pr-10 py-2 text-base rounded-md">
                ...
                <div>
                    ...
                    <InputError class="mt-2" :message="errors.project_url" />
                </div>
                <div class="mt-2">
